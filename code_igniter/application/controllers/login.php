...
<a href=".$this->config->config['oa_web_folder']."/help_ie.php target=\"_blank\"><img src=".$this->config->config['oa_web_folder']."/images/logo-IE.png alt='IE' width='65' height='65'></a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
