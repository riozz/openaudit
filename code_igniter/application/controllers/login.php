...
class login extends CI_Controller
{
    ...
    public function index($errmsg = "")
    {
        ...
        if ($license->license == 'none') {
            ...
            $data['oae_message'] = "Start Audit your PC (support IE9+, Chrome and Firefox):<p>1) Input your staff ID and click [Audit My PC] button above.<br>2) Keep the file anyway.<br> 3) Execute the file downloaded in step 1.<br>4) Audit starts, please don't close the audit process window.<a href=".$this->config->config['oa_web_folder']."/images/step3.png target=\"_blank\"><img src=".$this->config->config['oa_web_folder'] . "/images/step3.png alt='audit in progress' width='65' height='17'> </a><br>5) Audit completed when audit window closes.<p>
Please click the corresponding icon (IE9+, Chrome or Firefox) below for more Help<br><a href=".$this->config->config['oa_web_folder']."/help_ie.php target=\"_blank\"><img src=".$this->config->config['oa_web_folder']."/images/logo-IE.png alt='IE' width='65' height='65'></a>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href=".$this->config->config['oa_web_folder']."/help_chrome.php target=\"_blank\"><img src=".$this->config->config['oa_web_folder']."/images/logo-chrome.png alt='Chrome' width='65' height='65'></a>
&nbsp;&nbsp;&nbsp;<a href=".$this->config->config['oa_web_folder']."/help_ff.php target=\"_blank\"><img src=".$this->config->config['oa_web_folder']."/images/logo-ff.png alt='Chrome' width='100' height='65'></a>";
